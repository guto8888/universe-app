  ...
  return loading ? (
    ...
    <div className={style.header}>
      ...
      <div className={style.formUniverse} >
        ...
        <CreateBtn props={{findDatabase, 'url': "http://localhost:3000/pages/api/solarSystem"}} />
      </div>
    </div>
      ...
      return (
        <div className={style.details} key={dataId}>
          ...
          <div className={style.btns}>
            <DeleteBtn props={{'uniData': dataId, findDatabase, 'url': 'http://localhost:3000/pages/api/solarSystem'}} />
