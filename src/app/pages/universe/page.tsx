  ...
  <>
    <div className={style.header}>
      ...
      <div className={style.formUniverse} >
        ...
        <CreateBtn props={{findDatabase, 'url': 'http://localhost:3000/pages/api/universe'}} />        
      </div>
    </div>
        ...
        {uniList.map(uniData => {
          ...
          return (
            <div className={style.details} key={dataId}>
              ...
              <DeleteBtn props={{'uniData': dataId, findDatabase, 'url': 'http://localhost:3000/pages/api/universe'}} />
