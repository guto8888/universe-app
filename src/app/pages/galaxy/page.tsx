  ...
  return loading ? (
    ...
    <div className={style.header}>
      ...
      <div className={style.formUniverse} >
        ...
        <CreateBtn props={{findDatabase, 'url': `${process.env.BASE_URL}/pages/api/galaxy`}} />
      </div>
    </div>
        ...
        return (
          <div className={style.details} key={dataId}>
            ...
            <div className={style.btns}>
              <DeleteBtn props={{findDatabase, 'url': `${process.env.BASE_URL}/pages/api/galaxy`, 'uniData': dataId }} />
