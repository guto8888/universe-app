      ...
      <div className={style.divHeader}>
        ...
        <div className={style.mainDiv}>
          ...
          <div className={style.mainDivBtn}>
            <EditConfirmBtn props={{'type': newType, 'href': "/pages/restCelestialBodies", 'name': String(newName), 'id': newId, 'age': newAge, 'url': `${process.env.BASE_URL}/pages/api/restCelestialBodies`}} />
          </div>
        </div>
      </div>
