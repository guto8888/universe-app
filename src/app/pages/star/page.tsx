...
export default function Menu() {
  ...
  return loading ? (
    ...
    <CreateBtn props={{findDatabase, 'url': `${process.env.BASE_URL}/pages/api/star`}} />
    </div>
  </div>
  <div className={style.divAll}>
    ...
    <DeleteBtn props={{'uniData': dataId, findDatabase, 'url': `${process.env.BASE_URL}/pages/api/star`}} />
